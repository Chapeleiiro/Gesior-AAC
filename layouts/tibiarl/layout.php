  	...
  	<div id="MainHelper1">
    	<div id="MainHelper2">
								...
								<div id="support_Submenu" class="Submenu">
									<a href="?subtopic=rules">
  										<div id="submenu_rules" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
											<div class="LeftChain" style="background-image:url(<?php echo $layout_name; ?>/images/global/general/chain.gif);"></div>
											<div id="ActiveSubmenuItemIcon_rules" class="ActiveSubmenuItemIcon" style="background-image:url(<?php echo $layout_name; ?>/images/global/menu/icon-activesubmenu.gif);"></div>
											<div id="ActiveSubmenuItemLabel_rules" class="SubmenuitemLabel">Rules</div>
											<div class="RightChain" style="background-image:url(<?php echo $layout_name; ?>/images/global/general/chain.gif);"></div>
  										</div>
									</a>
									<a href="?subtopic=team">
  										<div id="submenu_team" class="Submenuitem" onmouseover="MouseOverSubmenuItem(this)" onmouseout="MouseOutSubmenuItem(this)">
											...
											<div id="ActiveSubmenuItemLabel_team" class="SubmenuitemLabel">Team</div>
											<div class="RightChain" style="background-image:url(<?php echo $layout_name; ?>/images/global/general/chain.gif);"></div>
  										</div>
									</a>
								</div>
              				...
              				<div id="ContentHelper">
								<script type="text/javascript" src="<?php echo $layout_name; ?>/newsticker.js"></script>								
							 	...
							 	<div id="ThemeboxesColumn">
									...
									<?php 
										if($config['social']['status']) { # set your social networks in config.php
									?>
			<!-- Facebook theme box -->
			...
			<div class="Bottom" style="background-image:url(<?php echo $layout_name; ?>/images/global/general/box-bottom.gif);">
											...
											<div id="TwitterBlock">
												<a href="https://twitter.com/<?php echo $config['social']['twitter']; ?>" class="twitter-follow-button" data-show-count="false">Follow @<?php echo $config['social']['twitter']; ?></a>
