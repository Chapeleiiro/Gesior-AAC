															...
															<table class="TableContent" width="100%">
																<tr>
																	<td><table style="width:100%;text-align:center">
																			...
																			<td valign="top"><a href="" target="_blank" type="application/octet-stream" target="_top">Client 11.47</a> |
																				<a href="" target="_blank" type="application/octet-stream" target="_top">Client 10</a>
																				<a href="" target="_blank" type="application/octet-stream" target="_top"> Minimap</a></br>
																				</td>
																				<td valign="top"><a href="" target="_blank" type="application/octet-stream" target="_top">Standalone IP Changer</a>
