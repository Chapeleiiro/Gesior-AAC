														...
														<div class="TableContentContainer" >
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																...
																<tr>
																	...
																	<td>
																		<input id="email" name="email" class="CipAjaxInput" style="width:206px;float:left;" value="'.(isset($_POST['email']) ? htmlspecialchars(substr($_POST['email'], 0, 50)) : '').'" size="30" maxlength="50" onBlur="SendAjaxCip({DataType: \'Container\'}, {Href: \'./account/ajax_email.php\',PostData: \'a_EMail=\'+encodeURIComponent(this.value),Method: \'POST\'});" />
															...
															<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																...
																<tr>
																	<td><input type="checkbox" name="agreeagreements" value="true"  onClick="if(this.checked == true) {  document.getElementById(\'agreeagreements_errormessage\').innerHTML = \'\';} else {  document.getElementById(\'agreeagreements_errormessage\').innerHTML = \'You have to agree to the '.$config['server']['serverName'].' Rules in order to create an account!\';}"'.($_POST['step'] == 'docreate' && !isset($e['rules']) ? ' checked="checked"' : '').'/>
																		I agree to the <a href="#" target="_blank" >'.$config['server']['serverName'].' Rules</a>.</td>
																</tr>
																<tr>
